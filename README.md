...
```bash
wget -O /tmp/luci-app-helium.ipk https://github.com/mss-col/openwrt-packages/raw/main/packages/all/luci-app-helium_1.0.12-1_all.ipk && opkg install /tmp/luci-app-helium.ipk
```
